<template>
  <div ref="cvContent" class="cv-a4-page cv-executive">
    <div class="cv-grid">
      <!-- Left Sidebar -->
      <aside class="cv-sidebar">
        ...
        <!-- Skills -->
        <div v-if="cv.skill_details.length > 0" class="cv-side-block">
...
.cv-skill-fill {
  height: 100%;
  background: linear-gradient(90deg, #c9a227, #e0b94e);
  border-radius: 2px;
...
.cv-accent-bar {
  height: 3px;
  background: linear-gradient(90deg, #c9a227, #e0b94e, #c9a227);
  border-radius: 2px;
  margin-bottom: 4px;
}
